...
<main id="maincontent" role="main">
    <div class="middle-align container">
        <?php
            $theme_lay = get_theme_mod( 'vw_one_page_theme_options','Right Sidebar');
            if($theme_lay == 'Left Sidebar'){ ?>
                <div class="row">
                    <div class="col-lg-4 col-md-4" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','vw-one-page'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1> 
                        <?php if ( have_posts() ) :
                            /* Start the Loop */
                        ...
                        <div class="navigation">
                            <?php
                                ...
                                the_posts_pagination( array(
                                    'prev_text'          => __( 'Previous page', 'vw-one-page' ),
                                    'next_text'          => __( 'Next page', 'vw-one-page' ),
                                    'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-one-page' ) . ' </span>',
                                ) );
                            ?>
