...
<footer role="contentinfo">
    ...
    <div id="footer-2">
      	<div class="copyright container">
            ...
            <?php if( get_theme_mod( 'vw_one_page_hide_show_scroll',true) != '') { ?>
                <?php $theme_lay = get_theme_mod( 'vw_one_page_scroll_top_alignment','Right');
                    if($theme_lay == 'Left'){ ?>
                        <a href="#" class="scrollup left"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-one-page' ); ?></span></a>
                    <?php }else if($theme_lay == 'Center'){ ?>
                        <a href="#" class="scrollup center"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-one-page' ); ?></span></a>
                    <?php }else{ ?>
                        <a href="#" class="scrollup"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-one-page' ); ?></span></a>
                <?php }?>
            <?php }?>
      	</div>
      	<div class="clear"></div>
